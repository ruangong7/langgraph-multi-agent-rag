...
primary_assistant_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "- Knowledge graph queries / entity relationship questions → ToKnowledgeGraph"
            "\n\nKnowledge Graph Delegation:"
            "- When user asks about relationships: 'which hotels are near my destination?', 'what flights connect through Zurich?'"
            "- When user asks to find connections between entities: 'how is flight LH123 related to Marriott Zurich?'"
            "- When user needs structured context about an entity: 'tell me everything about my booking'"
